...
const newCategoryBooks = {
    'life-science': [
        ...
        ['고요한 붉은 달', '서윤아', '', 'Syntropy Books 큐레이션', '생명이 감추고 드러내는 서정적이고 선택적인 존재 방식을 탐색합니다.', 'life-science.svg']
    ],
    'systems-thinking': [
        ['시스템 사고', '피터 센게', '', 'Syntropy Books 큐레이션', '조직과 사회 전체의 구조와 흐름을 바라보는 사고법을 소개합니다.', 'systems-thinking.svg'],
        ['사라지는 경계', '나재호', '', 'Syntropy Books 큐레이션', '관계와 경계가 흐르는 사회를 이해하는 실전적 분석을 제시합니다.', 'systems-thinking.svg'],
        ['달빛 아래의 네트워크', '정우진', '', 'Syntropy Books 큐레이션', '네트워크 안에서 관계가 만들어내는 질서와 불균형을 고민합니다.', 'systems-thinking.svg']
    ],
    complexity: [
        ...
        ['무질서의 그림자', '이도엽', '', 'Syntropy Books 큐레이션', '복잡한 문제에서 혼란을 읽는 인식의 틀을 정리합니다.', 'complexity.svg']
    ],
    cosmos: [
        ...
        ['태양의 반지', '김지혜', '', 'Syntropy Books 큐레이션', '태양계와 인간의 위치를 전반적 관점으로 다시 고찰합니다.', 'cosmos.svg']
    ],
    evolution: [
        ...
        ['진화의 가벼움', '빈예준', '', 'Syntropy Books 큐레이션', '진화가 천천히 그리고 가볍게 만들어내는 변화의 심리를 살펴봅니다.', 'evolution.svg']
    ],
    energy: [
        ...
        ['도시에서 배우는 평온', '신유나', '', 'Syntropy Books 큐레이션', '에너지와 감정, 도시의 구조가 평온을 만드는 방식을 생각합니다.', 'energy.svg']
    ],
    ecology: [
        ...
        ['생태계의 낮은 목소리', '문지환', '', 'Syntropy Books 큐레이션', '작은 생태적 신호들이 전체를 어떻게 움직이는지 살펴봅니다.', 'ecology.svg']
    ],
    philosophy: [
